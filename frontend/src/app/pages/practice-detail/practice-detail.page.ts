          ...
          <div class="flex flex-wrap items-center gap-2 mb-3">
            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-bold bg-white text-practice-700 shadow-sm">
              ...
              <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path d="M6.5 6.5h11M6.5 6.5a2 2 0 01-4 0 2 2 0 014 0zM17.5 6.5a2 2 0 004 0 2 2 0 00-4 0zM6.5 17.5h11M6.5 17.5a2 2 0 01-4 0 2 2 0 014 0zM17.5 17.5a2 2 0 004 0 2 2 0 00-4 0zM6.5 6.5v11M17.5 6.5v11" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
              Practice Set
            </span>
            @if (isCompleted()) {
